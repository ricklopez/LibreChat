# File: client/src/components/Chat/Input/MCPSubMenu.tsx

# 1. Purpose
**File Type:** TSX (UI component)

**What this file represents:**
This file is a ui component located at `client/src/components/Chat/Input/MCPSubMenu.tsx`.
