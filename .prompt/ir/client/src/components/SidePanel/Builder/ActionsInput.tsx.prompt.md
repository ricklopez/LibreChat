# File: client/src/components/SidePanel/Builder/ActionsInput.tsx

# 1. Purpose
**File Type:** TSX (UI component)

**What this file represents:**
This file is a ui component located at `client/src/components/SidePanel/Builder/ActionsInput.tsx`.
...
**Aliased Imports:**
- `~/components/SidePanel/Builder/ActionCallback`
- `~/Providers`
- `~/data-provider`
- `~/hooks`
