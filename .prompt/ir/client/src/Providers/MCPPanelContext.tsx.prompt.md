# File: client/src/Providers/MCPPanelContext.tsx

# 1. Purpose
**File Type:** TSX (UI component)

**What this file represents:**
This file is a ui component located at `client/src/Providers/MCPPanelContext.tsx`.

**Documentation:** Context value only created when conversationId chang
...
- `MCPPanelProvider({ children }: { children: React.ReactNode })`
- `useMCPPanelContext()`
