# File: api/utils/extractBaseURL.spec.js

# 1. Purpose
**File Type:** JS (Utility / Helper function)

**What this file represents:**
This file is a utility / helper function located at `api/utils/extractBaseURL.spec.js`.

**Documentation:** localhost:8080/v1/chat/completions';
