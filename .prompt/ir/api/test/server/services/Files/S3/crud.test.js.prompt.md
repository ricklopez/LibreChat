# File: api/test/server/services/Files/S3/crud.test.js

# 1. Purpose
**File Type:** JS (Business logic service)

**What this file represents:**
This file is a business logic service located at `api/test/server/services/Files/S3/crud.test.js`.

**Documentation:** Mock AWS SDK
