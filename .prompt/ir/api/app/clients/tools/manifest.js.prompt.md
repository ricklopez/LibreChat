# File: api/app/clients/tools/manifest.js

# 1. Purpose
**File Type:** JS (Application code)

**What this file represents:**
This file is a application code located at `api/app/clients/tools/manifest.js`.

**Documentation:** @type {Record<string, TPlugin | undefined>} */
