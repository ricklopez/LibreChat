# File: api/server/services/Files/Azure/images.js

# 1. Purpose
**File Type:** JS (Business logic service)

**What this file represents:**
This file is a business logic service located at `api/server/services/Files/Azure/images.js`.

**Documentation:** * Uploads an image file to Azure Blob Storage.
