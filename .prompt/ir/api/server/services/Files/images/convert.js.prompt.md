# File: api/server/services/Files/images/convert.js

# 1. Purpose
**File Type:** JS (Business logic service)

**What this file represents:**
This file is a business logic service located at `api/server/services/Files/images/convert.js`.

**Documentation:** * Converts an image file or buffer to target output type with specified resolution.
