...
This file is a business logic service located at `api/server/services/Files/images/resize.js`.

**Documentation:** * Resizes an image from a given buffer based on the specified resolution.
