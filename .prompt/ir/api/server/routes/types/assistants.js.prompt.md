# File: api/server/routes/types/assistants.js

# 1. Purpose
**File Type:** JS (API endpoint / Request handler)

**What this file represents:**
This file is a api endpoint / request handler located at `api/server/routes/types/assistants.js`.

**Documentation:** * Enum for the possible tools that can be enabled on an assistant.
