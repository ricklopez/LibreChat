# File: api/server/routes/edit/anthropic.js

# 1. Purpose
**File Type:** JS (API endpoint / Request handler)

**What this file represents:**
This file is a api endpoint / request handler located at `api/server/routes/edit/anthropic.js`.
...
**Aliased Imports:**
- `~/server/controllers/EditController`
