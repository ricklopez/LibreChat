# File: packages/data-schemas/src/types/prompts.ts

# 1. Purpose
**File Type:** TS (TypeScript type definitions)

**What this file represents:**
This file is a typescript type definitions located at `packages/data-schemas/src/types/prompts.ts`.
...
- `IPrompt()` — named export
- `IPromptGroup()` — named export
- `IPromptGroupDocument()` — named export
