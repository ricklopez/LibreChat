# File: packages/data-schemas/src/methods/userGroup.methods.spec.ts

# 1. Purpose
**File Type:** TS (Application code)

**What this file represents:**
This file is a application code located at `packages/data-schemas/src/methods/userGroup.methods.spec.ts`.
