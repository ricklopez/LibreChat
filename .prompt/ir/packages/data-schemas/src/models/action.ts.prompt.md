# File: packages/data-schemas/src/models/action.ts

# 1. Purpose
**File Type:** TS (Data model / Database schema)

**What this file represents:**
This file is a data model / database schema located at `packages/data-schemas/src/models/action.ts`.

**Documentation:** * Creates or returns the Action model using the provided mongoose instance and schema
...
- `createActionModel(mongoose: typeof import('mongoose')`
