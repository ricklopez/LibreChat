# File: packages/data-schemas/src/models/agentCategory.ts

# 1. Purpose
**File Type:** TS (Data model / Database schema)

**What this file represents:**
This file is a data model / database schema located at `packages/data-schemas/src/models/agentCategory.ts`.

**Documentation:** as t from '~/types';

**Primary exports:** 1 exported element(s)
- createAgentCategoryModel
...
- `createAgentCategoryModel(mongoose: typeof import('mongoose')`
