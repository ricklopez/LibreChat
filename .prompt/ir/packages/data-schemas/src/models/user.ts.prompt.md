# File: packages/data-schemas/src/models/user.ts

# 1. Purpose
**File Type:** TS (Data model / Database schema)

**What this file represents:**
This file is a data model / database schema located at `packages/data-schemas/src/models/user.ts`.
...
- `createUserModel(mongoose: typeof import('mongoose')`
