# File: packages/data-schemas/src/models/prompt.ts

# 1. Purpose
**File Type:** TS (Data model / Database schema)

**What this file represents:**
This file is a data model / database schema located at `packages/data-schemas/src/models/prompt.ts`.

**Documentation:** * Creates or returns the Prompt model using the provided mongoose instance and schema
...
- `createPromptModel(mongoose: typeof import('mongoose')`
