# File: packages/data-schemas/src/models/promptGroup.ts

# 1. Purpose
**File Type:** TS (Data model / Database schema)

**What this file represents:**
This file is a data model / database schema located at `packages/data-schemas/src/models/promptGroup.ts`.

**Documentation:** * Creates or returns the PromptGroup model using the provided mongoose instance and schema

**Primary exports:** 1 exported element(s)
- createPromptGroupModel
...
- `createPromptGroupModel(mongoose: typeof import('mongoose')`
