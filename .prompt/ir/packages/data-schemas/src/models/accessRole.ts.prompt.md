# File: packages/data-schemas/src/models/accessRole.ts

# 1. Purpose
**File Type:** TS (Data model / Database schema)

**What this file represents:**
This file is a data model / database schema located at `packages/data-schemas/src/models/accessRole.ts`.

**Documentation:** as t from '~/types';

**Primary exports:** 1 exported element(s)
- createAccessRoleModel
...
- `createAccessRoleModel(mongoose: typeof import('mongoose')`
