# File: packages/data-schemas/src/models/role.ts

# 1. Purpose
**File Type:** TS (Data model / Database schema)

**What this file represents:**
This file is a data model / database schema located at `packages/data-schemas/src/models/role.ts`.

**Documentation:** * Creates or returns the Role model using the provided mongoose instance and schema
...
- `createRoleModel(mongoose: typeof import('mongoose')`
